...
@JsonKey(name: 'user_id') String get userId; String get subscriber;// @JsonKey(name: 'first_name') required String firstName,
// @JsonKey(name: 'last_name') required String lastName,
@JsonKey(name: 'full_name') String get fullName; String get email;@JsonKey(name: 'mobile_no') String get mobileNo;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userId,subscriber,fullName,email,mobileNo);
...
@useResult
$Res call({
@JsonKey(name: 'user_id') String userId, String subscriber,@JsonKey(name: 'full_name') String fullName, String email,@JsonKey(name: 'mobile_no') String mobileNo
});
...
/// Create a copy of SignupResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? subscriber = null,Object? fullName = null,Object? email = null,Object? mobileNo = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'user_id')  String userId,  String subscriber, @JsonKey(name: 'full_name')  String fullName,  String email, @JsonKey(name: 'mobile_no')  String mobileNo)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignupResponseModel() when $default != null:
return $default(_that.userId,_that.subscriber,_that.fullName,_that.email,_that.mobileNo);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'user_id')  String userId,  String subscriber, @JsonKey(name: 'full_name')  String fullName,  String email, @JsonKey(name: 'mobile_no')  String mobileNo)  $default,) {final _that = this;
switch (_that) {
case _SignupResponseModel():
return $default(_that.userId,_that.subscriber,_that.fullName,_that.email,_that.mobileNo);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'user_id')  String userId,  String subscriber, @JsonKey(name: 'full_name')  String fullName,  String email, @JsonKey(name: 'mobile_no')  String mobileNo)?  $default,) {final _that = this;
switch (_that) {
case _SignupResponseModel() when $default != null:
return $default(_that.userId,_that.subscriber,_that.fullName,_that.email,_that.mobileNo);case _:
  return null;
...
class _SignupResponseModel extends SignupResponseModel {
  const _SignupResponseModel({@JsonKey(name: 'user_id') required this.userId, required this.subscriber, @JsonKey(name: 'full_name') required this.fullName, required this.email, @JsonKey(name: 'mobile_no') required this.mobileNo}): super._();
...
/// Create a copy of SignupResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? subscriber = null,Object? fullName = null,Object? email = null,Object? mobileNo = null,}) {
