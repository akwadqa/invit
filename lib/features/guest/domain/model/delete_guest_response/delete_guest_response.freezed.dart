...
mixin _$DeleteGuestsResponse {
  ...
  $DeleteGuestsResponseCopyWith<DeleteGuestsResponse> get copyWith =>
      _$DeleteGuestsResponseCopyWithImpl<DeleteGuestsResponse>(
          this as DeleteGuestsResponse, _$identity);
...
abstract mixin class $DeleteGuestsResponseCopyWith<$Res> {
  factory $DeleteGuestsResponseCopyWith(DeleteGuestsResponse value,
          $Res Function(DeleteGuestsResponse) _then) =
      _$DeleteGuestsResponseCopyWithImpl;
  @useResult
  $Res call(
      {List<String> deleted,
...
extension DeleteGuestsResponsePatterns on DeleteGuestsResponse {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DeleteGuestsResponse value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String> deleted,
            @JsonKey(name: 'not_found') List<String> notFound)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _DeleteGuestsResponse() when $default != null:
        return $default(_that.deleted, _that.notFound);
      case _:
        return orElse();
    }
  }
...
class _DeleteGuestsResponse implements DeleteGuestsResponse {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DeleteGuestsResponseCopyWith<_DeleteGuestsResponse> get copyWith =>
      __$DeleteGuestsResponseCopyWithImpl<_DeleteGuestsResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$DeleteGuestsResponseToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _DeleteGuestsResponse &&
...
/// @nodoc
abstract mixin class _$DeleteGuestsResponseCopyWith<$Res>
    implements $DeleteGuestsResponseCopyWith<$Res> {
  factory _$DeleteGuestsResponseCopyWith(_DeleteGuestsResponse value,
          $Res Function(_DeleteGuestsResponse) _then) =
      __$DeleteGuestsResponseCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<String> deleted,
