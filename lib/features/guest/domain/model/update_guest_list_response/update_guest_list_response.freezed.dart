...
mixin _$UpdateGuestListResponse {
  ...
  List<AddedInviteeModel> get addedInvitees;

  /// Create a copy of UpdateGuestListResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UpdateGuestListResponseCopyWith<UpdateGuestListResponse> get copyWith =>
      _$UpdateGuestListResponseCopyWithImpl<UpdateGuestListResponse>(
          this as UpdateGuestListResponse, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UpdateGuestListResponse &&
...
abstract mixin class $UpdateGuestListResponseCopyWith<$Res> {
  factory $UpdateGuestListResponseCopyWith(UpdateGuestListResponse value,
          $Res Function(UpdateGuestListResponse) _then) =
      _$UpdateGuestListResponseCopyWithImpl;
  @useResult
  $Res call(
      ...
      @JsonKey(name: 'added_invitees') List<AddedInviteeModel> addedInvitees});
}
...
extension UpdateGuestListResponsePatterns on UpdateGuestListResponse {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UpdateGuestListResponse value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            ...
            @JsonKey(name: 'skipped_count') int skippedCount,
            @JsonKey(name: 'added_invitees')
            List<AddedInviteeModel> addedInvitees)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
...
class _UpdateGuestListResponse implements UpdateGuestListResponse {
  const _UpdateGuestListResponse(
      ...
      @JsonKey(name: 'added_invitees')
      required final List<AddedInviteeModel> addedInvitees})
      : _addedInvitees = addedInvitees;
  factory _UpdateGuestListResponse.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UpdateGuestListResponseCopyWith<_UpdateGuestListResponse> get copyWith =>
      __$UpdateGuestListResponseCopyWithImpl<_UpdateGuestListResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UpdateGuestListResponseToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UpdateGuestListResponse &&
            (identical(other.occasionId, occasionId) ||
                other.occasionId == occasionId) &&
            (identical(other.addedCount, addedCount) ||
                other.addedCount == addedCount) &&
...
/// @nodoc
abstract mixin class _$UpdateGuestListResponseCopyWith<$Res>
    implements $UpdateGuestListResponseCopyWith<$Res> {
  factory _$UpdateGuestListResponseCopyWith(_UpdateGuestListResponse value,
          $Res Function(_UpdateGuestListResponse) _then) =
      __$UpdateGuestListResponseCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'occasion_id') String occasionId,
...
mixin _$AddedInviteeModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $AddedInviteeModelCopyWith<AddedInviteeModel> get copyWith =>
      _$AddedInviteeModelCopyWithImpl<AddedInviteeModel>(
          this as AddedInviteeModel, _$identity);
...
abstract mixin class $AddedInviteeModelCopyWith<$Res> {
  factory $AddedInviteeModelCopyWith(
          AddedInviteeModel value, $Res Function(AddedInviteeModel) _then) =
      _$AddedInviteeModelCopyWithImpl;
  @useResult
  $Res call(
...
extension AddedInviteeModelPatterns on AddedInviteeModel {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AddedInviteeModel value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _AddedInviteeModel implements AddedInviteeModel {
  const _AddedInviteeModel(
      {@JsonKey(name: 'invitee_id') required this.inviteeId,
      @JsonKey(name: 'full_name') required this.fullName});
  factory _AddedInviteeModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AddedInviteeModelCopyWith<_AddedInviteeModel> get copyWith =>
      __$AddedInviteeModelCopyWithImpl<_AddedInviteeModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AddedInviteeModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AddedInviteeModelCopyWith<$Res>
    implements $AddedInviteeModelCopyWith<$Res> {
  factory _$AddedInviteeModelCopyWith(
          _AddedInviteeModel value, $Res Function(_AddedInviteeModel) _then) =
      __$AddedInviteeModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'invitee_id') String inviteeId,
