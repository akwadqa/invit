...
class _$GuestReportModelCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      totalInvitees: null == totalInvitees
          ? _self.totalInvitees
          : totalInvitees // ignore: cast_nullable_to_non_nullable
              as int,
      notSent: null == notSent
          ? _self.notSent
...
class _GuestReportModel implements GuestReportModel {
  const _GuestReportModel(
      {@JsonKey(name: 'total_invitees') required this.totalInvitees,
      @JsonKey(name: 'not_sent') required this.notSent,
      @JsonKey(name: 'pending') required this.pending,
      @JsonKey(name: 'confirmed') required this.confirmed,
      @JsonKey(name: 'declined') required this.declined,
      @JsonKey(name: 'failed') required this.failed,
      @JsonKey(name: 'scanned_count') required this.scannedCount});
