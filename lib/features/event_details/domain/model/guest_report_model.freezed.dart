...
@JsonKey(name: 'total_invitees') int get totalInvitees;@JsonKey(name: 'not_sent') int get notSent; int get pending; int get confirmed; int get declined; int get failed;@JsonKey(name: 'scanned_count') int get scannedCount;
...
@useResult
$Res call({
@JsonKey(name: 'total_invitees') int totalInvitees,@JsonKey(name: 'not_sent') int notSent, int pending, int confirmed, int declined, int failed,@JsonKey(name: 'scanned_count') int scannedCount
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'total_invitees')  int totalInvitees, @JsonKey(name: 'not_sent')  int notSent,  int pending,  int confirmed,  int declined,  int failed, @JsonKey(name: 'scanned_count')  int scannedCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GuestReportModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'total_invitees')  int totalInvitees, @JsonKey(name: 'not_sent')  int notSent,  int pending,  int confirmed,  int declined,  int failed, @JsonKey(name: 'scanned_count')  int scannedCount)  $default,) {final _that = this;
switch (_that) {
case _GuestReportModel():
return $default(_that.totalInvitees,_that.notSent,_that.pending,_that.confirmed,_that.declined,_that.failed,_that.scannedCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'total_invitees')  int totalInvitees, @JsonKey(name: 'not_sent')  int notSent,  int pending,  int confirmed,  int declined,  int failed, @JsonKey(name: 'scanned_count')  int scannedCount)?  $default,) {final _that = this;
switch (_that) {
case _GuestReportModel() when $default != null:
return $default(_that.totalInvitees,_that.notSent,_that.pending,_that.confirmed,_that.declined,_that.failed,_that.scannedCount);case _:
  return null;
...
class _GuestReportModel implements GuestReportModel {
  const _GuestReportModel({@JsonKey(name: 'total_invitees') this.totalInvitees = 0, @JsonKey(name: 'not_sent') this.notSent = 0, this.pending = 0, this.confirmed = 0, this.declined = 0, this.failed = 0, @JsonKey(name: 'scanned_count') this.scannedCount = 0});
