...
extension BannerModelPatterns on BannerModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: 'banner_image') String bannerImage,
            @JsonKey(name: 'banner_title') String bannerTitle)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _BannerModel() when $default != null:
        return $default(_that.bannerImage, _that.bannerTitle);
      case _:
        return orElse();
    }
  }
...
class _BannerModel implements BannerModel {
  const _BannerModel(
      {@JsonKey(name: 'banner_image') required this.bannerImage,
      @JsonKey(name: 'banner_title') required this.bannerTitle});
